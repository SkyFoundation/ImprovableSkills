...
public class GuiSkilledAnvil extends GuiContainer implements IContainerListener
{
	private static final ResourceLocation ANVIL_RESOURCE = new ResourceLocation("textures/gui/container/anvil.png");
	private final ContainerSkilledAnvil anvil;
	private GuiTextField nameField;
	private final InventoryPlayer playerInventory;
	
	public GuiSkilledAnvil(InventoryPlayer inventoryIn, World worldIn)
	{
		super(new ContainerSkilledAnvil(inventoryIn, worldIn, Minecraft.getMinecraft().player));
		this.playerInventory = inventoryIn;
		this.anvil = (ContainerSkilledAnvil) this.inventorySlots;
	}
